	...
	public class CPUmethod {
		...
		public static int main() throws FileNotFoundException { //red because needs return value
			...
			return (int)executionCompletionStatus;
		...
		public static long cpu() {
			...
			while(!(HALT && ERROR)) { //while it is not halt and there is no error
				...
				case 1: //add
					...
					if(status == null) {
						return ERRORVALUE;	//if status1 is null, error
					}
					...
					if(opOneAddress < ERRORFETCH) {
						System.out.print("Invalid address... 1");	//validation to see if value is -1, error
						return ERRORVALUE;
					}
					...
					if(opTwoAddress < ERRORFETCH) {
						System.out.print("Invalid address... 2");
						return ERRORVALUE;
					}
				...
				case 2: //subtract
					...
					if(opOneAddress < ERRORFETCH) {
						System.out.print("Invalid address...3");
						return ERRORVALUE;
					}
					if(opOneValue < ERRORFETCH) {
						System.out.print("Invalid value...");
					...
					if(opTwoAddress < ERRORFETCH) {
						System.out.print("Invalid address...4");
						return ERRORVALUE;
					}
					if(opTwoValue < ERRORFETCH) {
						System.out.print("Invalid value...");
				...
				case 3: //multiply
					...
					if(opOneAddress < ERRORFETCH) {
						System.out.print("Invalid address...11");
						return ERRORVALUE;
					}
					if(opOneValue < ERRORFETCH) {
						System.out.print("Invalid value...");
					...
					if(opTwoAddress < ERRORFETCH) {
						System.out.print("Invalid address...22");
						return ERRORVALUE;
					}
					if(opTwoValue < ERRORFETCH) {
						System.out.print("Invalid value...");
				...
				case 4:	//division
					...
					if(opOneAddress < ERRORFETCH) {
						System.out.print("Invalid address...33");
						return ERRORVALUE;
					}
					if(opOneValue < ERRORFETCH) {
						System.out.print("Invalid value...");
					...
					if(opTwoAddress < ERRORFETCH) {
						System.out.print("Invalid address...44");
						return ERRORVALUE;
					}
					if(opTwoValue < ERRORFETCH) {
						System.out.print("Invalid value...");
				...
				case 5:	//move
					...
					//if(opOneAddress != ERRORFETCH) {
						//System.out.print("Invalid address...111");
						//return ERRORVALUE;
					//}
					if(opOneValue < ERRORFETCH) {
						System.out.print("Invalid value...");
					...
					//if(opTwoAddress == ERRORFETCH) {
						//System.out.print("Invalid address...222");
						//return ERRORVALUE;
					//}
					if(opTwoValue < ERRORFETCH) {
						System.out.print("Invalid value...");
