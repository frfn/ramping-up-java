...
import DataStructureStack.BasicStack;
...
public class BasicStackTest {
	/**
	 * Initialized a BasicStack with type String -- Data Structure will hold string objects.
	 */
	
	static BasicStack<String> stack = new BasicStack<String>();
	...
	public static void main(String[] args) {
		...
		//StackTest app = new StackTest();  // Creating from the same class! How cool.	
	
		/**
		 * All these OTHER methods are made IN this class. 
		 */
		
		//app.stackCards();  // utilizing the .push method
		
		//app.unstackCards();  // utilizing the .pop method
		
		//restack cards
		//app.stackCards();  // .pop method
	...
	public void unstackCards() {			
		...
		while(stack.size() > 0) {
			System.out.println(stack.pop());  // here you can see right away.
		}
	}
