...
public class e_jumpingOnClouds {
     ...
     public static void main(String[] args){
         System.out.println(jumpingOnClouds(new int[] {0, 1, 0, 0, 0, 1, 1, 0}));
     }

     public static int jumpingOnClouds(int[] c) {
         int count = -1;

         // this was an elegant solution | we found to 'skip' a number in the array by doing i++ in the 'if' condition
